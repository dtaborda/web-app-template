...
metadata:
  author: inmoautos
  version: "1.0"
  scope: [root]                                   # Which AGENTS.md: root
...
```yaml
# skills/dtaborda-web/SKILL.md
metadata:
  author: dTaborda
  version: "1.0"
  scope: [root]
  auto_invoke: "When working in ui or modifying frontend React/Next.js code"
```
...
| Action | Skill |
|--------|-------|
| When working in ui or modifying frontend React/Next.js code | `dtaborda-web` |
```
